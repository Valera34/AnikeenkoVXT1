...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name = "greetByAll", path = "greetByAll",
            httpMethod = HttpMethod.GET)

    public HelloClass greetByAll (@Named("name") String name,@Named("surname") String surname, @Named("period") String period) {
        return new HelloClass(name,surname,period);
    }
}
